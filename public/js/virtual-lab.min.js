...
var compuestopedia = {
	...
	create: function(){
		...
		compuestoName = game.add.text(game.width/3, game.height/4, 'wqw', {
		...
		compuestoKey = game.add.text(game.width/3 + 70, game.height/3 - 14, 'qwe', {
		...
		compuestoComponents = game.add.text(game.width/3 - 40, (game.height/3 * 2) -30 , 'qwe', {
			font: 'bold 24px sans-serif',
			fill: 'black',
			align: 'center',
			wordWrap: true,
		...
		compuestoDescription = game.add.text(game.width/2 + 50, game.height/4 + 30, 'qwe', {
		...
		compuestoImage = game.add.sprite(game.width/3+ 20, game.height/2.5, 'qwe');
