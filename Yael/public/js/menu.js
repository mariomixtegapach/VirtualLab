...
var menu = {
	preload : function(){
		game.load.image('labBackgroundBlur', './assets/img/labBackgroundBlur.jpg');
		game.load.image('button', './assets/img/button.png');
		game.load.image('window', './assets/img/window.png');
		game.load.audio('boilding', ['./assets/sounds/boilding_background.mp3']);
		game.load.audio('clinking', ['./assets/sounds/clinking_background.mp3']);
		game.load.audio('mice', ['./assets/sounds/mice_squeacking_background.mp3']);
	}, 
	create: function(){
