...
var compuestopedia = {
	preload: function(){
		game.load.image('desktopBackground', './assets/img/desktop_background.jpg');
		game.load.image('transparentButton', './assets/img/transparent_button.gif');
		game.load.spritesheet('book', './assets/img/book_sprite_sheet.png', 372, 299);
		game.load.audio('openBook', './assets/sounds/open_book_sound.mp3');
		game.load.audio('switchPage', './assets/sounds/switch_page.mp3');
